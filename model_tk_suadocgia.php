<?php
include_once('sua_docgia_tk.php');?>
<form method="post">
  <div class="modal fade" id="a<?php echo $row['id']; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="font-size: 18px; text-align: left; margin-left: 27px;">
        <div>
          Mã độc giả:
            <input type="text" name="id" style="margin-left: 35px; background-color: lightblue;" value="<?php echo $row['id'];?>"  required readonly> 
        </div>
        <div>
          Tài khoản:
            <input type="text" name="model_madg" style="margin-left: 45px; margin-top:10px;" value="<?php echo $row['madg']; ?>"  required> 
        </div>
        <div>
          Mật khẩu: 
        ...
        <div style="margin-top: 10px;">
          ...
          if ($row['role']=="0") {
          ?>
          <select name="role" style="margin-left: 85px; width: 200px; height: 30px;">
            <option value="0" selected>Thủ thư</option>
          ...
          <select name="role" style="margin-left: 85px; width: 200px; height: 30px;">
            ...
            <option value="1" selected>Độc giả</option>
          </select>
          <?php
          }
          ?>
