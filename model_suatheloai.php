  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="font-size: 18px; text-align: left; margin-left: 27px;">
        ...
        <div>
            Mã thể loại:
            <input type="text" name="modal_mtl" style="margin-left: 20px;" value="<?php echo $row['id']; ?>"  required readonly> 
        </div>
        <div>
          Thể loại: 
          <input type="text" name="modal_ttl" style="margin-left: 45px; margin-top:10px;" value="<?php echo $row['tentheloai']; ?>" required>
        </div>
        <div>
          Mô tả: 
          <input type="text" name="modal_mota" style="margin-left: 60px; margin-top:10px;" value="<?php echo $row['mota']; ?>" >
        </div>
