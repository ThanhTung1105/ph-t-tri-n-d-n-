          ...
          <div>
            <div style="margin-top:0px; margin-left: 30px;">
              <form action="" method="post">
                ...
                <p style="margin-top: -10px;">Mật khẩu: <input type="password" name="password_dky" id="password_dky" style="width: 180px; margin-left: 60px;"value="<?php echo isset($_POST['password_dky']) ? $_POST['password_dky'] : ''?>" ></p>
                <p style="margin-top: -10px;">Xác nhận: <input type="password" name="confirmpassword_dky" id="confirmpassword_dky" style="width: 180px; margin-left: 65px;" value="<?php echo isset($_POST['confirmpassword_dky']) ? $_POST['confirmpassword_dky'] : ''?>" ></p>
                <div >
