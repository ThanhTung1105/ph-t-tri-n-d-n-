  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div>
          <table style="background-color: white; font-size: 16px; border: 0px;" class="table_2_2">
            <tr style="background-color: white; font-size: 16px; border: 0px;">
              <td class="td2_2" style="border: 0px;">Tác giả:</td>
              <td class="td2_2" style="border: 0px; font-weight: bold;"><?php echo $row['tacgia']; ?></td>
            </tr>

            <tr style="background-color: white; font-size: 16px; border: 0px;">
              <td class="td2_2" style="border: 0px;">Nhà xuất bản:</td>
              <td class="td2_2" style="border: 0px; font-weight: bold;"><?php echo $row['nxb']; ?></td>
            </tr>

            <tr style="background-color: white; font-size: 16px; border: 0px;">
              <td class="td2_2" style="border: 0px;">Thể loại:</td>
              <td class="td2_2" style="border: 0px; font-weight: bold;"><?php echo $row['tentheloai']; ?></td>
            </tr>

            <tr style="background-color: white; font-size: 16px; border: 0px;">
              <td class="td2_2" style="border: 0px;">Giá:</td>
              <td class="td2_2" style="border: 0px; font-weight: bold;"><?php echo "".number_format($row['gia'], 0); ?>đ</td>
            </tr>

            <tr style="background-color: white; font-size: 16px; border: 0px;">
              <td class="td2_2" style="border: 0px;">Tình trạng:</td>
              <td class="td2_2" style="border: 0px; font-weight: bold;">
                <?php 
