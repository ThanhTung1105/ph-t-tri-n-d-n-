    		...
    		<div class="modal-content">
      			...
      			<div class="modal-body" style="font-size: 18px; text-align: left; margin-left: 27px;">
      				<table class="table_sua_ctpm">
      					<tr>
      						...
      						<td class="td_sua_ctpm"><input type="text" name="id_pm" value="<?php echo $row['id']; ?>" required readonly/></td>
      					</tr>
      					<tr>
      					...
      					<tr>
      						...
      						<td class="td_sua_ctpm"><select name="modal_masach" style='width: 200px; height: 30px;'>
      								<?php
      					...
      					<tr>
      						...
      						<td class="td_sua_ctpm"><input type="text" name="modal_tg" value="<?php echo $row['ngaytra']; ?>" required></td>
      					</tr>
      					<tr>
      					...
      					<tr>
      						...
      						<td class="td_sua_ctpm"><select name="modal_cb" style='width: 200px; height: 30px;'>
      								<?php
      			...
      			<div class="modal-footer">
			        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			       	...
			       	<form method="get">
			          	<input type="submit" name="save_suapmct" value="save" style="background-color: #2196f3; color: white; height: 45px; width: 70px; border-radius: 5px; border: 0px; font-size:20px;">
			       	</form>
      			</div>
