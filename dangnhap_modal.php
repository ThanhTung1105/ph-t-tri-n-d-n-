                                    ...
                                    <div>
                                        ...
                                        <div style="margin-left:475px; margin-top: -335px;">
                                            <form action="" method="post" id="f_qldg" name="f_qldg">
                                                ...
                                                <p>Tên đăng nhập: &nbsp; <input type="text" name="tendangnhap" style="width: 180px;" value="<?php echo isset($_POST['tendangnhap']) ? $_POST['tendangnhap'] : ''?> " required></p>
                                                <p>Mật khẩu: <input type="password" name="password" id="password" style="width: 180px; margin-left: 63px;" minlength="3" value="<?php echo isset($_POST['password']) ? $_POST['password'] : ''?>" required></p>
                                                <div>
