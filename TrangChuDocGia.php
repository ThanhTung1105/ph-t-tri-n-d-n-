...
if (isset($_GET['id_dn'])) {
    ...
    // echo(123); // Hiển thị toàn bộ kết quả truy vấn
    // var_dump($resss); // Hiển thị toàn bộ kết quả truy vấn
        ...
        <body style="background-color: #ccccff">
            ...
            <article>
                <div class="tab">
                    ...
                    <?php
                    } elseif (isset($_POST['timkiem_tcdg']) or isset($_GET['qlvtt'])) {
                    ?>
                        <button class="tablinks" onclick="openTrangChu(event,'dsm')"><img src="img\contact-list.png" width="64px" height="64px"> &nbsp; <b>DANH SÁCH MƯỢN</b></button>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar_dsm" style="margin-top: 30px; height: 250px;">
                            ...
                            <table class="table table-bordered table-striped mb-0 table_dsm1">
                                ...
                                if (mysqli_num_rows($res_count) > 0) {
                                    $sql = "SELECT danhsachmuon.id, sach.gia, sach.tensach as tensachs, sach.tacgia, danhsachmuon.soluongmuon, sach.nxb, sach.id_sach FROM danhsachmuon INNER JOIN sach ON danhsachmuon.tensach = sach.id_sach
                                ...
                                ?>
                                        ...
                                        $sql = "SELECT danhsachmuon.id, sach.gia, danhsachmuon.ngaytra, sach.tensach as tensachs, sach.tacgia, danhsachmuon.soluongmuon, sach.nxb, sach.id_sach, danhsachmuon.tinhtrang FROM danhsachmuon INNER JOIN sach ON danhsachmuon.tensach = sach.id_sach
                                        WHERE nm='$tendn' ";
                                        $rs = mysqli_query($conn, $sql);
                                        if (mysqli_num_rows($rs) > 0) {
                                        ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="7" rowspan="2" style="text-align: center;">Danh sách mượn trống!</td>
                                        </tr>
                                    </tbody>
                                <?php
                                }
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Giá</th>
                                            <th scope="col">Tình trạng</th>
                                            <th scope="col" style="text-align: center;">Chi tiết sách</th>
                                            <th scope="col" style="text-align: center;">Thêm vào dsm</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
            ...
            <footer style="margin-top: -30px; background-color: #ccccff; width: 100%; height: 220px;">
                ...
                <div class="footer-" style="margin-top: -210px; margin-left: 200px;">
                    <a href="TrangChuDocGia.php?id_dn=<?php echo $tendn; ?>">
